...
module lab4_tb;
  ...
  parameter BASE_RAM_INIT_FILE = "D:/2022/senior/computerOrganization/cod22-wk-li20/thinpad_top.srcs/sources_1/new/lab4/base.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "D:/2022/senior/computerOrganization/cod22-wk-li20/thinpad_top.srcs/sources_1/new/lab4/ext.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路径
