...
module lab5_tb;
 ...
 parameter BASE_RAM_INIT_FILE = "D:/2022/senior/computerOrganization/cod22-wk-li20/thinpad_top.srcs/sources_1/new/lab5/base.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路径
  parameter EXT_RAM_INIT_FILE = "D:/2022/senior/computerOrganization/cod22-wk-li20/thinpad_top.srcs/sources_1/new/lab5/ext.bin";  // ExtRAM 初始化文件，请修改为实际的绝对路径

  initial begin
    // 在这里可以自定义测试输入序列，例如：
    dip_sw = 32'h8040_0000;
    touch_btn = 0;
    reset_btn = 0;
    push_btn = 0;
